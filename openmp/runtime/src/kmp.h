...
//typedef int (*launch_t_m)(int gtid, ident_t* loc);//nader
...
extern int __kmp_invoke_task_func(int gtid);//nader
...
//extern int __kmp_invoke_teams_master(int gtid, ident_t *loc);//nader
