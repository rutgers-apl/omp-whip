...
static void __kmpc_omp_task_begin_if0_template(ident_t *loc_ref, kmp_int32 gtid,
  ...
  if (ompt) {
    ...
    if (ompt_enabled.ompt_callback_task_create) {//nader
      ...
      ompt_callbacks.ompt_callback(ompt_callback_task_create)(
          ...
          //return_address);
          return_address,loc_ref->psource);
    }
  ...
  if (UNLIKELY(ompt_enabled.enabled && !new_taskdata->td_flags.started)) {
    ...
    if (ompt_enabled.ompt_callback_task_create) {
      ...
      ompt_callbacks.ompt_callback(ompt_callback_task_create)(//nader
          ...
          //OMPT_LOAD_RETURN_ADDRESS(gtid));
          OMPT_LOAD_RETURN_ADDRESS(gtid), loc_ref->psource);
    }
  }
#endif
...
void __kmpc_taskloop(ident_t *loc, int gtid, kmp_task_t *task, int if_val,
  ...
  if (ompt_enabled.ompt_callback_work) {//nader taskloop
...
#if OMPT_SUPPORT && OMPT_OPTIONAL
  if (ompt_enabled.ompt_callback_work) {//nader taskloop end
    ompt_callbacks.ompt_callback(ompt_callback_work)(
