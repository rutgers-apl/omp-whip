  ...
  if (ompt_enabled.enabled &&
    ...
    if (ompt_enabled.ompt_callback_parallel_begin) {
      ...
      ompt_callbacks.ompt_callback(ompt_callback_parallel_begin)(
          ...
          &ompt_parallel_data, team_size, ompt_invoker_program, codeptr, loc->psource);//nader parallel begin
    }
  }
#endif // OMPT_SUPPORT
    ...
    if (ompt_enabled.enabled) {
      if (ompt_enabled.ompt_callback_parallel_begin) {
        ...
        ompt_callbacks.ompt_callback(ompt_callback_parallel_begin)(
            ...
            OMPT_INVOKER(call_context), return_address, loc->psource);//nader parallel begin
      }
  ...
  if (!initial_thread && ompt_enabled.enabled) {
    ...
    if (ompt_enabled.ompt_callback_task_create) {
      ompt_callbacks.ompt_callback(ompt_callback_task_create)(//nader
          ...
          NULL, NULL, task_data, ompt_task_initial, 0, NULL, "initial");
