...
#define ompt_event_release_critical_implemented ompt_event_MAY_ALWAYS_TRACE //nader
...
#define ompt_event_wait_critical_implemented ompt_event_MAY_ALWAYS_TRACE //nader
...
#define ompt_event_acquired_nest_lock_next_implemented                         \
  ompt_event_MAY_ALWAYS_TRACE
#define ompt_event_acquired_critical_implemented ompt_event_MAY_ALWAYS_TRACE //nader
...
#define ompt_event_task_alloc_implemented ompt_event_MAY_ALWAYS
#define ompt_event_single_in_block_begin_wloc_implemented ompt_event_MAY_ALWAYS_TRACE
#define ompt_event_dispatch_next_implemented ompt_event_MAY_ALWAYS
#define ompt_event_dispatch_next_others_implemented ompt_event_MAY_ALWAYS
#endif
