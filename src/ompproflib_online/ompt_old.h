...
#define FOREACH_OMPT_EVENT(macro)                                                                               \
                                                                                                                \
    /*--- Mandatory Events ---*/                                                                                \
    macro (ompt_event_parallel_begin,           ompt_new_parallel_callback_t_wloc,   1) /* parallel begin */         \
    ...
    macro (ompt_event_release_critical,         ompt_wait_callback_t_wloc,          19) /* critical release */       \
                                                                                                                \
    ...
    macro (ompt_event_implicit_task_begin,      ompt_parallel_callback_t_wloc,      22) /* implicit task begin nader   */  \
    ...
    macro (ompt_event_task_switch,              ompt_task_pair_callback_t,     26) /* task switch */            \
                                                                                                                \
    macro (ompt_event_loop_begin,               ompt_new_workshare_callback_t_wloc, 27) /* task at loop begin */     \
    ...
    macro (ompt_event_workshare_end,            ompt_parallel_callback_t,      36) /* task at workshare end */  \
                                                                                                                \
    macro (ompt_event_master_begin,             ompt_parallel_callback_t_wloc,      37) /* task at master begin nader */   \
    ...
    macro (ompt_event_wait_critical,            ompt_wait_callback_t_wloc,          48) /* critical wait */          \
    ...
    macro (ompt_event_acquired_critical,        ompt_wait_callback_t_wloc,          54) /* critical acquired */      \
    ...
    macro (ompt_event_task_alloc,               ompt_new_task_callback_t_wloc,     71) /* nader task-alloc callback */ \
    macro (ompt_event_single_in_block_begin_wloc, ompt_new_workshare_callback_t_wloc, 72) /*nader task at single begin with location info*/    \
    macro (ompt_event_dispatch_next,               ompt_for_dispatch_next_4_t,     73) /* nader dispatch callback */ \
    macro (ompt_event_dispatch_next_others,               ompt_for_dispatch_next_t,     74) /* nader dispatch other loops callback */ \
/*****************************************************************************
 * data types
 *****************************************************************************/
...
typedef void (*ompt_wait_callback_t_wloc) (
    ompt_wait_id_t wait_id,            /* wait id                      */
    char const *psource
);

typedef void (*ompt_for_dispatch_next_4_t)(
    int lb,            /* lower bound                      */
    int ub,            /* upper bound                      */
    int st,            /* stride bound                     */
    int last          /* last flag                        */
...
typedef void (*ompt_for_dispatch_next_t)(
    int last          /* last flag                        */
);
...
typedef void (*ompt_parallel_callback_t_wloc) (
    ompt_parallel_id_t parallel_id,    /* id of parallel region       */
    ompt_task_id_t task_id,             /* id of task                  */
    char const *psource
);
...
typedef void (*ompt_new_workshare_callback_t_wloc) (
    ompt_parallel_id_t parallel_id,   /* id of parallel region        */
    ompt_task_id_t parent_task_id,    /* id of parent task            */
    void *workshare_function,          /* pointer to outlined function */
    char const *psource                /* location of single construct */
);
...
typedef void (*ompt_new_parallel_callback_t_wloc) (
    ompt_task_id_t parent_task_id,    /* id of parent task            */
    ompt_frame_t *parent_task_frame,  /* frame data of parent task    */
    ompt_parallel_id_t parallel_id,   /* id of parallel region        */
    uint32_t requested_team_size,     /* number of threads in team    */
    void *parallel_function,          /* pointer to outlined function */
    char const *psource,                /* location of parallel construct */
    ompt_invoker_t invoker          /* who invokes master task?     */
);
...
typedef void (*ompt_new_task_callback_t_wloc) (
    ompt_task_id_t parent_task_id,    /* id of parent task            */
    ompt_frame_t *parent_task_frame,  /* frame data for parent task   */
    ompt_task_id_t  new_task_id,      /* id of created task           */
    void *task_function,               /* pointer to outlined function */
    char const *psource                /* location of task construct */
);
